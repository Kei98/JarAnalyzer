...
public class Draw extends JComponent {
    ...
    //genera un random, podria funcionar para la logica del grafo...
    ControlPanel control = new ControlPanel();
    private int radius = RADIUS;
    private Kind kind = Kind.Circular;
    //aqui la wea del grafico...
    ...
    class ControlPanel extends JToolBar {
        ...
        private Action newNode = new NewNodeAction("Visualizar el Grafo");
        private Action clearAll = new ClearAction("Nuevo");
   ...
   /* private class ColorAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            color = JColorChooser.showDialog(
                Draw.this, "Choose a color", color);
            if (color != null) {
...
///////////////////////////////////////
    ...
    private class NewNodeAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            //Color color = control.hueIcon.getColor();
            Node n = new Node(p, radius, Color.MAGENTA, kind);
            n.setSelected(true);
            nodes.add(n);
            repaint();
        }
    }
    // hace el random... no necesario... talvez util para la logica...
