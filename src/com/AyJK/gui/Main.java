	...
	private class Search implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if (val == JFileChooser.OPEN_DIALOG) {
				...
				boolean isArchivoRenombrado = selectorArchivos.getSelectedFile().renameTo(new File(directorioActual + "\\text1.png"));//este ultimo puede ser una variable y que la consultes por consola o con un dialogo.
